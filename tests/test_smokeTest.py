...
class TestSmokeTest():
  ...
  def test_joinPageTest(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Joy")
    self.driver.find_element(By.NAME, "lname").send_keys("Oyaleke")
    self.driver.find_element(By.NAME, "bizname").send_keys("Temple concept ")
    self.driver.find_element(By.NAME, "biztitle").send_keys("product manager")
  ...
  def test_adminPageTest(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("joy")
    self.driver.find_element(By.ID, "password").send_keys("jamesss")
